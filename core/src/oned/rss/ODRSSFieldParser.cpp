...
{
	//printf("ParseFieldsInGeneralPurpose rawInfo %s, result %s\n", rawInfo.c_str(), result.c_str());
	if (rawInfo.empty()) {
	...
	//printf(" fieldSize %d, ai %s, field %s, remaining %s\n", (int)fieldSize, ai.c_str(), field.c_str(), remaining.c_str());
